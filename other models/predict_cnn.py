...
n_steps=24; n_pred=12; n_features=5; var='NDVI'                                            # data preparation parameters
...
for cell in p_normalized.index[m:]:
    ...
    with warnings.catch_warnings():
        ...
        results = Parallel(n_jobs=8)\
            (delayed(predict_batchsize)(frame_b, b) for b in tqdm(np.arange(1,9)))
...
df_p.to_csv(f'C:\Projects\Drought\Code\output\cnn\{var}\{var}_{m}_{n}.csv', index=None)   
